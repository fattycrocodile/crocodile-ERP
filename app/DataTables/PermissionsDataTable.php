...
class PermissionsDataTable extends DataTable
{
                ...
                return "
                    <div class='form-group'>
                        <div class='btn-group' role='group' aria-label='Basic example'>
                            <a href='permissions/$data->id/edit' class='btn btn-icon btn-secondary'><i class='fa fa-pencil-square-o'></i> Edit</a>
                            <button data-remote='permissions/$data->id/delete' class='btn btn-icon btn-danger btn-delete'><i class='fa fa-trash-o'></i> Delete</button>
                        </div>
                   </div>";
            })
            ->rawColumns(['action'])
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('group')->title('Permission Group'),
        ];
    }

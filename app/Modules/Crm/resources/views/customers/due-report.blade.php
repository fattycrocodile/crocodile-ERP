@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Due Report' }} @endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">CUSTOMER DUE REPORT CRITERIA</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" id="mr-form"
                                  action="{{route('crm.reports.due-report-view')}}"
                                  method="post"
                                  autocomplete="off">
                                @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="form-actions center">
                                            <a type="button" class="btn btn-warning mb-1"
                                               href="{{route('crm.reports.due-report')}}">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('crm.reports.due-report-view') }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),

@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Customer Return Report' }} @endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">CUSTOMER RETURN REPORT CRITERIA</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" id="mr-form"
                                  action="{{route('crm.reports.customer-return-report-view')}}"
                                  method="post"
                                  autocomplete="off">
                                @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="form-actions center">
                                            <a type="button" class="btn btn-warning mb-1"
                                               href="{{route('crm.reports.customer-return-report')}}">
    ...
    <section class="row report-view-section" style="display: none;">
        <div class="col-sm-12">
            <div id="kick-start" class="card">
                <div class="card-header">
                    <h4 class="card-title">CUSTOMER RETURN REPORT</h4>
                </div>
                <div class="card-content collapse show">
                    <div class="card-body">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('crm.reports.customer-return-report-view') }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),

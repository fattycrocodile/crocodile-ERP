@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Invoice Return Manage' }} @endsection
@push('styles')
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a type="button" class="btn btn-info btn-min-width mr-1 mb-1"
               href="{{ route('crm.invoiceReturn.create') }}"><i
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">PURCHASE RETURN MANAGE</h4>
                    ...
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content" style="min-width: 900px !important;">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal" onclick="closeModal()">Close
                                </button>
...
@push('scripts')
    ...
    <script>
        $('#invoice-return-table').on('click', '.btn-delete[data-remote]', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                headers: {
            ...
            if (confirm('Are you sure you want to delete this row?')) {
                $.ajax({
                    ...
                    $('#invoice-return-table').DataTable().draw(false);
        ...
        $('#invoice-return-table').on('click', '.btn-preview', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            var url = "{{ route('crm.invoiceReturn.voucher') }}";

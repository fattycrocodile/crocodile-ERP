<div class="row">
    <div class="col-12">
        <h2 class="text-center">Customer Return Report From {{  date("F jS, Y", strtotime($start_date)) }}
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th class="text-center">Return Invoice Count</th>
                    <th>Amount</th>
                </tr>
                </thead>
                <tbody>
                ...
                @foreach($data as $key => $dt)
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $dt->return_count }}</td>

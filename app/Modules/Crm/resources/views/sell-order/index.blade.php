@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Sales Order' }} @endsection
@push('styles')
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a type="button" class="btn btn-info btn-min-width mr-1 mb-1"
               href="{{route('crm.sales.order.create')}}"><i
...
@push('scripts')
    ...
    <script>
        $('#order-table').on('click', '.btn-delete[data-remote]', function (e) {
            ...
            if (confirm('Are you sure you want to delete this row?')) {
                $.ajax({
                    ...
                    $('#order-table').DataTable().draw(false);

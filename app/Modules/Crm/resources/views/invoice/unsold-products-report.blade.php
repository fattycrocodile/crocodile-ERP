            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">UNSOLD PRODUCTS REPORT CRITERIA</h4>
                                ...
                                <div class="col-12">
                                    <div class="form-actions center">
                                        <a type="button" class="btn btn-warning mb-1"
                                           href="{{route('crm.reports.unsold-products')}}">
    ...
    <section class="row report-view-section" style="display: none;">
        <div class="col-sm-12">
            <div id="kick-start" class="card">
                <div class="card-header">
                    <h4 class="card-title">UNSOLD PRODUCTS REPORT</h4>
                </div>
                <div class="card-content collapse show">
                    <div class="card-body">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('crm.reports.unsold-products-view') }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),

@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Sell Price' }} @endsection
@push('styles')
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a type="button" class="btn btn-info btn-min-width mr-1 mb-1"
               href="{{route('storeInventory.sellprices.create')}}"><i
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Products Sell Price</h4>
...
@push('scripts')
    ...
    <script>
        $('#sellprices-table').on('click', '.btn-delete[data-remote]', function (e) {
            ...
            if (confirm('Are you sure you want to delete this row?')) {
                $.ajax({
                    ...
                    $('#sellprices-table').DataTable().draw(false);

        ...
        <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-customer-details" class="row" style="width:100%;">
                ...
                <div class="col-md-12 col-sm-12 text-left text-md-left" style="width:30%;">
                    <p class="">Transfer To</p>
                </div>
                <div class="col-md-12 col-sm-12 text-left text-md-left" style="width:100%;">
                    <ul class="px-0 list-unstyled">
                        <li class="text-bold-800 text-muted">Name : {{ $data->receiveStore->name }}</li>
                        <li class="text-muted">Address : {{ $data->receiveStore->address }}</li>
                        <li class="text-muted">Phone : {{ $data->receiveStore->contact }}</li>
                    </ul>
                </div>
                </div>
                <div class="" style="width:50%;">
                <div class="col-md-12 col-sm-12 text-right text-md-right" style="width:100%; ">
                    ...
                    <p>
                        <span
                            class="text-muted">Invoice Date :</span> {{  date("F jS, Y", strtotime($data->date)) }}</li>
                    </p>
                    <p>
                        <span
                        ...
                        <table class="table bg-transparent">
                            ...
                            @foreach($data->storeTransferDetails as $key => $invD)
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{ $invD->product->code }}</td>
                            ...
                            <tr style="border-bottom: 0 !important;">
                                ...
                                <td class="text-right">{{$salesTotal}} Pcs</td>
                            </tr>

@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Warranties' }} @endsection
@push('styles')
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a type="button" class="btn btn-info btn-min-width mr-1 mb-1"
               href="{{route('storeInventory.warranties.create')}}"><i
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">WARRANTIES</h4>
...
@push('scripts')
    ...
    <script>
        $('#warranties-table').on('click', '.btn-delete[data-remote]', function (e) {
            ...
            if (confirm('Are you sure you want to delete this row?')) {
                $.ajax({
                    ...
                    $('#warranties-table').DataTable().draw(false);

@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Store Transfer Report' }} @endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">STORE TRANSFER REPORT CRITERIA</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" id="mr-form" action="{{route('storeInventory.reports.store-transfer-report-view')}}"
                                  method="post"
                                  autocomplete="off">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select id="send_store_id" name="send_store_id"
                                                        class="select2 form-control @error('send_store_id') is-invalid @enderror">
                                                    <option value="" selected="">Select Send Store</option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select id="rcv_store_id" name="rcv_store_id"
                                                        class="select2 form-control @error('rcv_store_id') is-invalid @enderror">
                                                    <option value="" selected="">Select Receive Store</option>
                                                    @foreach($stores as $key => $store)
                                                        <option value="{{ $key }}"> {{ $store }} </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-12">
                                        <div class="form-actions center">
                                            <a type="button" class="btn btn-warning mb-1"
                                               href="{{route('storeInventory.reports.store-transfer-report')}}">
    ...
    <section class="row report-view-section" style="display: none;">
        <div class="col-sm-12">
            <div id="kick-start" class="card">
                <div class="card-header">
                    <h4 class="card-title">STORE TRANSFER REPORT</h4>
                </div>
                <div class="card-content collapse show">
                    <div class="card-body">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('storeInventory.reports.store-transfer-report-view') }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),

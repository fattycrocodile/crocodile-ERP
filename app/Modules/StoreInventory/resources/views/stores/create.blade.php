        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        <form class="form" method="post" action="{{route('storeInventory.stores.store')}}"
                            ...
                            <div class="form-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="StoreCode"
                                                   ...
                                                   placeholder="Store code" value="{{ old('code') }}"
                                                   name="code">
                                            @error('code')
                                            <div class="help-block text-danger">{{ $message }} </div> @enderror
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <img id="pad_header_view" src="" alt="" width="100">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <img id="pad_footer_view" src="" alt="" width="100">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <img id="pad_view" src="" alt="" width="100">
                                    </div>
                                </div>

@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Products' }} @endsection
@push('styles')
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a type="button" class="btn btn-info btn-min-width mr-1 mb-1"
               href="{{route('storeInventory.products.create')}}"><i
...
@push('scripts')
    ...
    <script>
        $('#products-table').on('click', '.btn-delete[data-remote]', function (e) {

@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Product Wise Purchase Report' }} @endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">PRODUCT WISE PURCHASE REPORT CRITERIA</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" id="mr-form"
                                  action="{{route('commercial.reports.product-wise-purchase-view')}}"
                                  method="post"
                                  autocomplete="off">
                                @csrf
                                ...
                                <div class="col-12">
                                    <div class="form-actions center">
                                        <a type="button" class="btn btn-warning mb-1"
                                           href="{{route('commercial.reports.product-wise-purchase')}}">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('commercial.reports.product-wise-purchase-view') }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),

            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Create New Territory</h4>
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form" method="post" action="{{route('supplyChain.territory.store')}}">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="parentCategory">Area</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="territoryName"
                                                       ...
                                                       placeholder="Territory Name" value="{{ old('name') }}"
                                                       name="name">
                                                @error('name')
                                                <div class="help-block text-danger">{{ $message }} </div> @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="code"
                                                       ...
                                                       placeholder="Territory Code" value="{{ old('code') }}"
                                                       name="code">
                                                @error('code')
                                                <div class="help-block text-danger">{{ $message }} </div> @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="contact_no"
                                                       ...
                                                       placeholder="Contact" value="{{ old('contact_no') }}"
                                                       name="contact_no">
                                                @error('contact_no')
                                                <div class="help-block text-danger">{{ $message }} </div> @enderror
                                            </div>

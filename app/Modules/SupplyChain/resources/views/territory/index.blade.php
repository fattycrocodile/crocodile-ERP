@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Territory' }} @endsection
@push('styles')
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a type="button" class="btn btn-info btn-min-width mr-1 mb-1"
               href="{{route('supplyChain.territory.create')}}"><i
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">TERRITORY</h4>
...
@push('scripts')
    ...
    <script>
        $('#territory-table').on('click', '.btn-delete[data-remote]', function (e) {
            ...
            if (confirm('Are you sure you want to delete this row?')) {
                $.ajax({
                    ...
                    $('#territory-table').DataTable().draw(false);

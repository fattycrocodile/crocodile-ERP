@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Area' }} @endsection
@push('styles')
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a type="button" class="btn btn-info btn-min-width mr-1 mb-1"
               href="{{route('supplyChain.area.create')}}"><i
...
@push('scripts')
    ...
    <script>
        $('#area-table').on('click', '.btn-delete[data-remote]', function (e) {
            ...
            if (confirm('Are you sure you want to delete this row?')) {
                $.ajax({
                    ...
                    $('#area-table').DataTable().draw(false);

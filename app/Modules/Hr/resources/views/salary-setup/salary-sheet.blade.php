            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">SALARY SHEET CRITERIA</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" id="mr-form" action="{{route('hr.reports.salary-sheet-view')}}"
                                  method="post"
                                  autocomplete="off">
                                @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="form-actions center">
                                            <a type="button" class="btn btn-warning mb-1"
                                               href="{{route('hr.reports.salary-sheet')}}">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('hr.reports.salary-sheet-view') }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),

@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Salary' }} @endsection
@push('styles')
...
@push('scripts')
    ...
    <script>
        $('#salary-setup-table').on('click', '.btn-delete[data-remote]', function (e) {
            ...
            if (confirm('Are you sure you want to delete this row?')) {
                $.ajax({
                    ...
                    $('#salary-setup-table').DataTable().draw(false);

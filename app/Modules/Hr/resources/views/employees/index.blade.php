@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Employees' }} @endsection
@push('styles')
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a type="button" class="btn btn-info btn-min-width mr-1 mb-1"
               href="{{route('hr.employees.create')}}"><i
...
@push('scripts')
    ...
    <script>
        $('#employees-table').on('click', '.btn-delete[data-remote]', function (e) {

        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        <form class="form" method="post" action="{{route('hr.employees.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="full_name"
                                           ...
                                           placeholder="Employee Full Name" value="{{ old('full_name') }}"
                                           name="full_name">
                                    @error('full_name')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contact_no"
                                                   ...
                                                   placeholder="Phone No" value="{{ old('contact_no') }}"
                                                   name="contact_no">
                                            @error('contact_no')
                                            <div class="help-block text-danger">{{ $message }} </div> @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="marital_status" name="marital_status"
                                                ...
                                                @foreach($marital_status as $maritalstatus)
                                                    <option
                                                        value="{{$maritalstatus->code}}" {{ old('marital_status')==$maritalstatus->code?'selected':'' }}>{{$maritalstatus->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class='input-group date' id='datetimepicker1' data-provide="datepicker">
                                                <input type='text' name="dob" value="{{old('dob')}}" class="form-control @error('dob') is-invalid @enderror" data-date-format="Y-MM-DD" autocomplete="off"/>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class='input-group date' id='datetimepicker1' data-provide="datepicker">
                                                <input type='text' name="appointment_date" value="{{old('appointment_date')}}" class="form-control @error('appointment_date') is-invalid @enderror" data-date-format="Y-MM-DD" autocomplete="off" placeholder="Appointment Date"/>
                                                <div class="input-group-append">
                                                <span class="input-group-text">
                                                  <span class="fa fa-calendar"></span>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class='input-group date' id='datetimepicker1' data-provide="datepicker">
                                                <input type='text' name="join_date" value="{{old('join_date')}}" class="form-control @error('join_date') is-invalid @enderror" data-date-format="Y-MM-DD" autocomplete="off"/>
                                                <div class="input-group-append">
                                                <span class="input-group-text">
                                                  <span class="fa fa-calendar"></span>
                                                </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class='input-group date' id='datetimepicker1' data-provide="datepicker">
                                                <input type='text' name="permanent_date" value="{{old('permanent_date')}}" class="form-control @error('permanent_date') is-invalid @enderror" data-date-format="Y-MM-DD" autocomplete="off"/>
                                                <div class="input-group-append">
                                                <span class="input-group-text">
                                                  <span class="fa fa-calendar"></span>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="store_id" name="store_id"
                                                ...
                                                @foreach($stores as $store)
                                                    <option
                                                        value="{{$store->id}}" {{ old('store_id')==$store->id?'selected':'' }}>{{$store->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('store_id')
                                            <div class="help-block text-danger">{{ $message }} </div> @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="tin"
                                                   ...
                                                   placeholder="TIN No" value="{{ old('tin') }}"
                                                   name="tin">
                                            @error('tin')
                                            <div class="help-block text-danger">{{ $message }} </div> @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="bank_acc_no"
                                                   ...
                                                   placeholder="Bank Account No" value="{{ old('bank_acc_no') }}"
                                                   name="bank_acc_no">
                                            @error('bank_acc_no')
                                            <div class="help-block text-danger">{{ $message }} </div> @enderror
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p style="padding-top: 40px;" id="fileview" alt="" ></p>
                                    </div>
                                </div>

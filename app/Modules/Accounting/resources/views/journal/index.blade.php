@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Journal Manage' }} @endsection
@push('styles')
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a type="button" class="btn btn-info btn-min-width mr-1 mb-1"
               href="{{ route('accounting.journal.create') }}"><i
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">JOURNAL MANAGE</h4>
...
@push('scripts')
    ...
    <script>
        $('#journal-table').on('click', '.btn-delete[data-remote]', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                headers: {
        ...
        $('#journal-table').on('click', '.btn-preview', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')

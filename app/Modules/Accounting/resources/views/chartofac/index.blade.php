@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Chart Of Accounts' }} @endsection
@push('styles')
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a type="button" class="btn btn-info btn-min-width mr-1 mb-1"
               href="{{route('accounting.chartofaccounts.create')}}"><i
...
@push('scripts')
    ...
    <script>
        $('#chartofac-table').on('click', '.btn-delete[data-remote]', function (e) {
            ...
            if (confirm('Are you sure you want to delete this row?')) {
                $.ajax({
                    ...
                    $('#chartofac-table').DataTable().draw(false);

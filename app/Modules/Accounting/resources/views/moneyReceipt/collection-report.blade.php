@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Collection Report' }} @endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">COLLECTION REPORT CRITERIA</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" id="mr-form" action="{{route('accounting.reports.collection-view')}}"
                                  method="post"
                                  autocomplete="off">
                                @csrf
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="collection_type">Collection Method</label>
                                                <select id="collection_type" name="collection_type"
                                                        class="select2 form-control @error('collection_type') is-invalid @enderror">
                                                    <option value="" selected="">Select Collection Method</option>
                                                    @foreach($collection_types as $key => $store)
                                                        <option value="{{ $key }}"> {{ $store }} </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-12">
                                        <div class="form-actions center">
                                            <a type="button" class="btn btn-warning mb-1"
                                               href="{{route('accounting.reports.collection')}}">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('accounting.reports.collection-view') }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),

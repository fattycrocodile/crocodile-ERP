@extends('layouts.app')
@section('title') {{ isset($pageTitle) ? $pageTitle : 'Payment Report' }} @endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">PAYMENT REPORT CRITERIA</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" id="mr-form" action="{{route('accounting.reports.payment-view')}}"
                                  method="post"
                                  autocomplete="off">
                                @csrf
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select id="payment_type" name="payment_type"
                                                        class="select2 form-control @error('payment_type') is-invalid @enderror">
                                    ...
                                    <div class="col-12">
                                        <div class="form-actions center">
                                            <a type="button" class="btn btn-warning mb-1"
                                               href="{{route('accounting.reports.payment')}}">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('accounting.reports.payment-view') }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),

                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" id="mr-form"
                                  action="{{route('accounting.reports.profit-loss-report-view')}}"
                                  method="post"
                                  autocomplete="off">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="d-flex align-items-end" style="margin-bottom:0.5%;">
                                            ...
                                            <a type="button" class="btn btn-warning mb-1"
                                               href="{{route('accounting.reports.profit-loss-report')}}">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('accounting.reports.profit-loss-report-view') }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),

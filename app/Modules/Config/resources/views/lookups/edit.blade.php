        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        <form class="form" method="post" action="{{route('config.lookups.update',$lookups->id)}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="lookupName" class="form-control @error('name') is-invalid @enderror"
                                                   placeholder="Lookup Name" value="{{ old('name')?old('name'):$lookups->name }}"
                                                   name="name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="parentCategory" name="type" class="select2 form-control @error('type') is-invalid @enderror">
                                                ...
                                                <option value="gender" {{((old('type')?old('type'):$lookups->type)=="gender")?"selected":""}}> Gender </option>
                                                <option value="religion" {{((old('type')?old('type'):$lookups->type)=="religion")?"selected":""}}> Religion </option>
                                                <option value="marital_status" {{((old('type')?old('type'):$lookups->type)=="marital_status")?"selected":""}}> Marital Status </option>
                                            </select>

                ...
                <div id="recent-buyers" class="media-list height-300 position-relative">
                    ...
                    <a href="#" class="media border-0">
                      ...
                      <span class="avatar avatar-md avatar-busy">
                        <img class="media-object rounded-circle"
                             src="{{ asset('app-assets/images/portrait/small/avatar-s-9.png') }}"
                             alt="Generic placeholder image">
                        <i></i>
                      </span>
                        </div>
            ...
            <div class="card-content">
                <div class="card-body">
                    <p>Total paid invoices 240, unpaid 150.
                        <span class="float-right"><a href="project-summary.html" target="_blank">Invoice Summary <i
...
<div class="row match-height">
    ...
    <div class="col-xl-4 col-lg-12">
        <div class="card">
            ...
            <div class="card-content">
                <img class="img-fluid" src="{{ asset('app-assets/images/carousel/06.jpg') }}"
                     alt="Card image cap">
                <div class="card-body">
...
@push('scripts')
    ...
    <script src="{{ asset('app-assets/js/scripts/ui/breadcrumbs-with-stats.js') }}" type="text/javascript"></script>
@endpush
